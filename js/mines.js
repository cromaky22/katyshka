...
(function(){
  const GRID_SIZE = 25;
  // 🎰 HOUSE EDGE: Увеличивает вероятность попадания на мину (0.0 = fair/100% выигрыш, 0.35 = 35% преимущество казино)
  const HOUSE_EDGE = 0; // 0% преимущество казино - 100% ШАНС ВЫИГРЫША
