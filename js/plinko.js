document.addEventListener('DOMContentLoaded', function(){
  ...
  // Low 10: [43, 6.6, 1.9, 0.9, 0.6, 0.5, 0.6, 0.9, 1.9, 6.6, 43]
  // Low 12: [130, 17, 4.2, 1.5, 0.8, 0.5, 0.5, 0.5, 0.8, 1.5, 4.2, 17, 130]
  // Low 14: [380, 41, 8.9, 2.9, 1.3, 0.7, 0.5, 0.5, 0.5, 0.7, 1.3, 2.9, 8.9, 41, 380]
  // Low 16: [1100, 110, 21, 6, 2.2, 1.1, 0.7, 0.5, 0.4, 0.5, 0.7, 1.1, 2.2, 6, 21, 110, 1100]
  var MULTS = {
    low: {
      8:  [25, 5, 1.5, 0.7, 0.5, 0.5, 0.7, 1.5, 5, 25],
      10: [43, 6.6, 1.9, 0.9, 0.6, 0.5, 0.6, 0.9, 1.9, 6.6, 43],
      12: [130, 17, 4.2, 1.5, 0.8, 0.5, 0.5, 0.5, 0.8, 1.5, 4.2, 17, 130],
      14: [380, 41, 8.9, 2.9, 1.3, 0.7, 0.5, 0.5, 0.5, 0.7, 1.3, 2.9, 8.9, 41, 380],
      16: [1100, 110, 21, 6, 2.2, 1.1, 0.7, 0.5, 0.4, 0.5, 0.7, 1.1, 2.2, 6, 21, 110, 1100]
    },
    medium: {
      8:  [40, 8, 2, 0.6, 0.4, 0.6, 2, 8, 40],
      10: [70, 12, 3, 1, 0.5, 0.4, 0.5, 1, 3, 12, 70],
      12: [180, 25, 5.5, 1.8, 0.7, 0.4, 0.3, 0.4, 0.7, 1.8, 5.5, 25, 180],
      14: [320, 40, 8, 2.5, 0.9, 0.5, 0.3, 0.3, 0.5, 0.9, 2.5, 8, 40, 320],
      16: [500, 60, 12, 3.5, 1.2, 0.6, 0.4, 0.2, 0.4, 0.6, 1.2, 3.5, 12, 60, 500]
    },
    high: {
      8:  [60, 12, 2.5, 0.5, 0.3, 0.5, 2.5, 12, 60],
      10: [120, 20, 4, 0.8, 0.4, 0.3, 0.4, 0.8, 4, 20, 120],
      12: [300, 40, 7, 1.5, 0.6, 0.3, 0.2, 0.3, 0.6, 1.5, 7, 40, 300],
      14: [550, 65, 11, 2, 0.7, 0.4, 0.2, 0.2, 0.4, 0.7, 2, 11, 65, 550],
      16: [900, 100, 16, 3, 0.9, 0.5, 0.3, 0.2, 0.3, 0.5, 0.9, 3, 16, 100, 900]
    }
  };
