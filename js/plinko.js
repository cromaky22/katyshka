document.addEventListener('DOMContentLoaded', function(){
  ...
  // Multipliers — more loss slots (mult < 1) in all levels
  var MULTS = {
    low: {
      8:  [2.8, 1.6, 0.6, 0.3, 0.3, 0.6, 1.6, 2.8],
      10: [3.7, 1.5, 0.7, 0.4, 0.3, 0.4, 0.7, 1.5, 3.7],
      12: [5.3, 2, 0.8, 0.5, 0.3, 0.2, 0.3, 0.5, 0.8, 2, 5.3],
      14: [8.3, 3, 1, 0.6, 0.4, 0.2, 0.2, 0.2, 0.4, 0.6, 1, 3, 8.3],
      16: [12, 4, 1.3, 0.7, 0.5, 0.3, 0.2, 0.2, 0.3, 0.5, 0.7, 1.3, 4, 12]
    },
    medium: {
      8:  [6, 2.1, 0.5, 0.2, 0.2, 0.5, 2.1, 6],
      10: [13, 3, 0.7, 0.3, 0.2, 0.2, 0.3, 0.7, 3, 13],
      12: [24, 5, 1, 0.4, 0.2, 0.1, 0.2, 0.4, 1, 5, 24],
      14: [47, 8, 1.5, 0.5, 0.3, 0.1, 0.1, 0.3, 0.5, 1.5, 8, 47],
      16: [90, 15, 2.5, 0.8, 0.4, 0.2, 0.1, 0.2, 0.4, 0.8, 2.5, 15, 90]
    },
    high: {
      8:  [16, 3, 0.4, 0.1, 0.1, 0.4, 3, 16],
      10: [43, 6, 0.6, 0.2, 0.1, 0.1, 0.2, 0.6, 6, 43],
      12: [130, 15, 1.2, 0.3, 0.1, 0, 0.1, 0.3, 1.2, 15, 130],
      14: [360, 35, 2, 0.5, 0.2, 0, 0, 0.2, 0.5, 2, 35, 360],
      16: [1100, 90, 4, 0.8, 0.3, 0.1, 0, 0.1, 0.3, 0.8, 4, 90, 1100]
    }
  };
  ...
  // 97% balls drop to loss slots (mult < 1), only 3% to wins
